...
sed -i "s/FAUCET_URL=bitcoindfaucetonionaddress.onion/FAUCET_URL=$FAUCET_URL/" ./bitcoind_signet_node/fund-bitcoind.
sed -i "s/FAUCET_URL=bitcoindfaucetonionaddress.onion/FAUCET_URL=$FAUCET_URL/" ./c-lightning/fund-c-lightning.sh
